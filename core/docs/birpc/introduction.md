...
**Bidirectional Remote Procedure Call** (biRPC) は協調型 P2P システム向けに設計されたシンプルなメッセージングプロトコルです。
...
**メッセージ** は biRPC でピアと通信するための 3 種類のデータフレームです。
...
![Interactive RPC](https://raw.github.com/torao/kazzla/master/doc/images/biRPC-Sequence3.png)
