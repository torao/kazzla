...
class Domain private[Domain](val config:Configuration, val url:URL){
	...
	// ========================================================================
	/**
	 * このドメイン上で確保されている不必要なリソースを開放します。このメソッドはタイマーに
	 * により定期的に起動されます。
	 */
...
object Domain {
	...
	/**
	 * ドメインに接続するためのデフォルト TCP/IP ポートです。
	 */
	...
	// ========================================================================
	/**
	 * この仮想マシン上でインスタンス化されているドメインの一覧です。
	 */
	 ...
	 * 構築します。どの URL が使用されるかはランダムに決定されるため全ての URL が示すプロ
	 * フィールの内容は同じである必要があります。
	 * @param conf 接続設定
	...
	// ========================================================================
	/**
	 * この仮想マシンでインスタンス化されている全てのドメインをクローズします。
	 */
